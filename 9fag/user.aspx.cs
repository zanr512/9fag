...
namespace _9fag
{
    public partial class user1 : System.Web.UI.Page
    {
        ...
        {
            if (current_pass.Text == null)
            {
                Label1.Text = "Please enter all required information to change your account password";
            }
            else if(new_password.Text == null)
            {
                Label1.Text = "Please enter all required information to change your account password";
            }
            else if(new_pass1.Text == null)
            {
                Label1.Text = "Please enter all required information to change your account password";
            }
            else if(new_pass1.Text != new_password.Text)
            {
                Label1.Text = "Both passwords must match";
            }
            else
            {
                //Pridobi staro geslo
        ...
        protected void button_delete_Click(object sender, EventArgs e)
        {
            ...
            if (delete_pass == null)
            {
                ...
                del_pass1.Text = "Please enter and confirm password to delete account";
            ...
            else if(TextBox5.Text != delete_pass.Text)
            {
                del_pass1.Text = "Please enter and confirm password to delete account";
            }
            else
